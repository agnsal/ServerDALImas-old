...
aggiorna:-print('Mi sto aggiornando...'),compile('dati.pl'),compile('personale.pl'),print('Aggiornato!'),elabora.

elabora:-print('Sto elaborando!'),persona(var_X),dati(var_N,var_C,var_X),print('Controllo le mansioni di '),print(var_N),print(' '),print(var_C),print(' matricola '),print(var_X),print('... '),print('Mansioni rilevate: '),(lavoro(var_L,var_X)->print(var_L),print('. ');var_L is 0,print(var_L)),a(message(ermes,send_message(lavoroelaborato(var_L,var_X),mnemosine))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_160585,var_Ontology,_160587),_160582),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_160604)),a(message(var_Ag,propose(var_A,[_160604],var_AgI))),retractall(ext_agent(var_Ag,_160623,var_Ontology,_160625)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_160522,var_Ontology,_160524),_160519),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_160557,var_Ontology,_160559)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_160466,var_Ontology,_160468),_160463),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_160494,var_Ontology,_160496)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_160248),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_160265),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_160156).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_160080),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_160054),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_159992,_159993)),clause(agente(_160003,_160004,_160005,var_S),_160001),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_159889,_159890,_159891,var_S),_159887),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_159939,[]),repeat,read(_159939,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_159939).
