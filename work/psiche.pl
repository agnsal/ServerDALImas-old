...
eve(aggiornamento):-aggiorna.

aggiorna:-print('Mi sto aggiornando...'),compile('dati.pl'),print('Aggiornato!'),elabora.

elabora:-print('Sto elaborando!'),persona(var_X),dati(var_N,var_C,var_X),print('Test psicologico su '),print(var_N),print(' '),print(var_C),print(' matricola '),print(var_X),print('... '),(ha(var_X,animali)->var_Y is 4+0;var_Y=0),(namici(var_X,var_A),var_A>0->var_R is var_Y+4;var_R=var_Y),(colorepreferito(var_X,var_C),var_C is giallo->var_F is var_R+2;var_F=var_R),print('Felice: '),print(var_F),print(' su 10.'),a(message(ermes,send_message(testelaborato(var_F,var_X),psiche))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_161279,var_Ontology,_161281),_161276),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_161298)),a(message(var_Ag,propose(var_A,[_161298],var_AgI))),retractall(ext_agent(var_Ag,_161317,var_Ontology,_161319)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_161216,var_Ontology,_161218),_161213),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_161251,var_Ontology,_161253)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_161160,var_Ontology,_161162),_161157),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_161188,var_Ontology,_161190)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_160942),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_160959),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_160850).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_160774),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_160748),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_160686,_160687)),clause(agente(_160697,_160698,_160699,var_S),_160695),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_160583,_160584,_160585,var_S),_160581),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_160633,[]),repeat,read(_160633,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_160633).
