...
elabora:-start(var_X,var_Ti),arrivo(var_X,var_Tf),var_Durata is var_Tf-var_Ti,print('Sto elaborando!'),a(message(ermes,send_message(tempoelaborato(var_Durata,var_X),crono))),(var_Durata>=0->print('Tempo di tragitto: '),print(var_Durata);var_Durata<0->print('Impossibile! Tempo di tragitto: '),print(var_Durata)).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_158944,var_Ontology,_158946),_158941),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_158963)),a(message(var_Ag,propose(var_A,[_158963],var_AgI))),retractall(ext_agent(var_Ag,_158982,var_Ontology,_158984)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_158881,var_Ontology,_158883),_158878),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_158916,var_Ontology,_158918)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_158825,var_Ontology,_158827),_158822),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_158853,var_Ontology,_158855)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_158607),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_158624),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_158515).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_158439),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_158413),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_158351,_158352)),clause(agente(_158362,_158363,_158364,var_S),_158360),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_158248,_158249,_158250,var_S),_158246),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_158298,[]),repeat,read(_158298,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_158298).
