...
elabora:-print('Sto elaborando!'),persona(var_X),dati(var_N,var_C,var_X),print('Controllo le ore al pc di '),print(var_N),print(' '),print(var_C),print(' matricola '),print(var_X),print('... '),orepc(var_X,var_O),print(var_O),print(' ore '),(var_O>4->var_S=0,print('sono troppe! ');var_S=1,print('vanno bene. ')),a(message(ermes,send_message(misuraelaborato(var_S,var_X),atena))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_160542,var_Ontology,_160544),_160539),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_160561)),a(message(var_Ag,propose(var_A,[_160561],var_AgI))),retractall(ext_agent(var_Ag,_160580,var_Ontology,_160582)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_160479,var_Ontology,_160481),_160476),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_160514,var_Ontology,_160516)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_160423,var_Ontology,_160425),_160420),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_160451,var_Ontology,_160453)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_160205),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_160222),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_160113).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_160037),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_160011),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_159949,_159950)),clause(agente(_159960,_159961,_159962,var_S),_159958),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_159846,_159847,_159848,var_S),_159844),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_159896,[]),repeat,read(_159896,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_159896).
